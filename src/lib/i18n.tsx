...
const toolsKm = {
  ...
  qr: { name: "បង្កើត QR Code", desc: "បង្កើត និងស្កេនកូដ QR" },
  ...
  // 25 new
  whiteboard: { name: "ក្តារស", desc: "គូរនៅលើក្តារសស្អាត" },
  mind_map: { name: "ផែនទីគំនិត", desc: "បង្កើតផែនទីគំនិតដែលមានទំនាក់ទំនង" },
  flashcard_quiz: { name: "ប្រឡង Flashcard", desc: "សាកល្បងចំណេះដឹងជាមួយកាត" },
  music_player: { name: "កម្មវិធីចាក់តន្ត្រី", desc: "ចាក់ឯកសារសំឡេងពីឧបករណ៍" },
  color_blindness: { name: "ពិនិត្យពណ៌សម្រាប់ពិការភ្នែក", desc: "ក្លែងធ្វើពិការភ្នែកពណ៌" },
  json_to_csv: { name: "JSON → CSV", desc: "បំប្លែង JSON ទៅ CSV" },
  csv_editor: { name: "កម្មវិធីកែ CSV", desc: "កែសម្រួលទិន្នន័យ CSV" },
  markdown_to_html: { name: "Markdown → HTML", desc: "បំប្លែង Markdown ទៅ HTML" },
  image_resizer: { name: "ប្តូរទំហំរូបភាព", desc: "ប្តូរទំហំរូបភាពតាមតម្រូវការ" },
  pdf_to_image: { name: "PDF → រូបភាព", desc: "បំប្លែង PDF ទៅជារូបភាព" },
  audio_trimmer: { name: "កាត់សំឡេង", desc: "កាត់កែសម្រួលឯកសារសំឡេង" },
  video_trimmer: { name: "កាត់វីដេអូ", desc: "កាត់កែសម្រួលឯកសារវីដេអូ" },
  gif_maker: { name: "បង្កើត GIF", desc: "បង្កើត GIF ពីរូបភាពជាច្រើន" },
  calendar_tool: { name: "ប្រតិទិន", desc: "ប្រតិទិនជាមួយព្រឹត្តិការណ៍" },
  expense_tracker: { name: "តាមដានចំណាយ", desc: "តាមដានការចំណាយប្រចាំថ្ងៃ" },
  kanban_board: { name: "Kanban Board", desc: "គ្រប់គ្រងកិច្ចការជាក្រុម" },
  mood_tracker: { name: "តាមដានអារម្មណ៍", desc: "កត់ត្រាអារម្មណ៍ប្រចាំថ្ងៃ" },
  journal: { name: "កំណត់ហេតុ", desc: "សរសេរកំណត់ហេតុប្រចាំថ្ងៃ" },
  timer_intervals: { name: "កម្មវិធីកំណត់ពេល", desc: "កម្មវិធីកំណត់ពេលចន្លោះ" },
  speed_test: { name: "សាកល្បងល្បឿន", desc: "សាកល្បងល្បឿនអ៊ីនធើណែត" },
  text_encryptor: { name: "កូដអត្ថបទ", desc: "បំប្លែង និងដោះកូដអត្ថបទ" },
  uuid_generator: { name: "បង្កើត UUID", desc: "បង្កើតអត្តសញ្ញាណតែមួយគត់" },
...
const toolsEn = {
  ...
  qr: { name: "QR Code", desc: "Generate & scan QR codes" },
  ...
  // 25 new
  whiteboard: { name: "Whiteboard", desc: "Draw on a clean whiteboard" },
  mind_map: { name: "Mind Map", desc: "Create connected mind maps" },
  flashcard_quiz: { name: "Flashcard Quiz", desc: "Test knowledge with flashcards" },
  music_player: { name: "Music Player", desc: "Play audio files from device" },
  color_blindness: { name: "Color Blind Sim", desc: "Simulate color blindness types" },
  json_to_csv: { name: "JSON → CSV", desc: "Convert JSON to CSV format" },
  csv_editor: { name: "CSV Editor", desc: "Edit CSV data in a table" },
  markdown_to_html: { name: "MD → HTML", desc: "Convert Markdown to HTML" },
  image_resizer: { name: "Image Resizer", desc: "Resize images to custom dimensions" },
  pdf_to_image: { name: "PDF → Image", desc: "Convert PDF pages to images" },
  audio_trimmer: { name: "Audio Trimmer", desc: "Trim and cut audio files" },
  video_trimmer: { name: "Video Trimmer", desc: "Trim and cut video files" },
  gif_maker: { name: "GIF Maker", desc: "Create GIFs from multiple images" },
  calendar_tool: { name: "Calendar", desc: "Calendar with event tracking" },
  expense_tracker: { name: "Expense Tracker", desc: "Track daily expenses by category" },
  kanban_board: { name: "Kanban Board", desc: "Manage tasks in columns" },
  mood_tracker: { name: "Mood Tracker", desc: "Log your daily mood" },
  journal: { name: "Journal", desc: "Write daily journal entries" },
  timer_intervals: { name: "Interval Timer", desc: "Custom interval timer sequences" },
  speed_test: { name: "Speed Test", desc: "Test your internet speed" },
  text_encryptor: { name: "Text Encryptor", desc: "Encrypt and decrypt text" },
  uuid_generator: { name: "UUID Generator", desc: "Generate unique identifiers" },
