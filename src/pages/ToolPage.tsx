...
const toolComponents: Record<ToolId, React.LazyExoticComponent<React.FC>> = {
  ...
  // 25 new tools
  whiteboard: lazy(() => import("@/components/tools/Whiteboard")),
  mind_map: lazy(() => import("@/components/tools/MindMap")),
  flashcard_quiz: lazy(() => import("@/components/tools/FlashcardQuiz")),
  music_player: lazy(() => import("@/components/tools/MusicPlayer")),
  color_blindness: lazy(() => import("@/components/tools/ColorBlindness")),
  json_to_csv: lazy(() => import("@/components/tools/JsonToCsv")),
  csv_editor: lazy(() => import("@/components/tools/CsvEditor")),
  markdown_to_html: lazy(() => import("@/components/tools/MarkdownToHtml")),
  image_resizer: lazy(() => import("@/components/tools/ImageResizer")),
  pdf_to_image: lazy(() => import("@/components/tools/PdfToImage")),
  audio_trimmer: lazy(() => import("@/components/tools/AudioTrimmer")),
  video_trimmer: lazy(() => import("@/components/tools/VideoTrimmer")),
  gif_maker: lazy(() => import("@/components/tools/GifMaker")),
  calendar_tool: lazy(() => import("@/components/tools/CalendarTool")),
  expense_tracker: lazy(() => import("@/components/tools/ExpenseTracker")),
  kanban_board: lazy(() => import("@/components/tools/KanbanBoard")),
  mood_tracker: lazy(() => import("@/components/tools/MoodTracker")),
  journal: lazy(() => import("@/components/tools/Journal")),
  timer_intervals: lazy(() => import("@/components/tools/TimerIntervals")),
  speed_test: lazy(() => import("@/components/tools/SpeedTest")),
  text_encryptor: lazy(() => import("@/components/tools/TextEncryptor")),
  uuid_generator: lazy(() => import("@/components/tools/UuidGenerator")),
