...
export const ToolCard = forwardRef<HTMLDivElement, ToolCardProps>(({ tool, index }, ref) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="pointer-events-none absolute -top-1 -right-1 h-8 w-8 rounded-full bg-primary/10 opacity-0 group-hover:opacity-100"
      ...
      {/* Bottom shine effect */}
      <motion.div
        className="pointer-events-none absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-primary/40 to-transparent opacity-0 group-hover:opacity-100"
        initial={false}
